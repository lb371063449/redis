...
public class ProductCountBolt extends BaseRichBolt {
    ...
    private void initTaskId(int taskid) {
        ...
        log.debug("【ProductCountBolt获取到taskid list】taskidList= {}", taskidList);
        ...
        log.debug("【ProductCountBolt设置taskid list】taskidList= {}", taskidList);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    log.debug("【ProductCountThread打印productCountMap的长度】size= {}", productCountMap.size());
                    ...
                    log.debug("【ProductCountThread计算出一份top3热门商品列表】zk path=/task-hot-product-list-{}, topnProductListJSON= {}", taskid, topnProductListJSON);
    ...
    public void execute(Tuple tuple) {
        ...
        log.debug("【ProductCountBolt接收到一个商品id】 productId= {}", productId);
        ...
        log.debug("【ProductCountBolt完成商品访问次数统计】productId= {} count=", productId, count);
    }
